...
const Contact = () => {
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'shayan8839@gmail.com',
      href: 'mailto:shayan8839@gmail.com',
    },
    {
      icon: Phone,
      label: 'Phone',
      value: '+91 8839091380',
      href: 'tel:+918839091380',
    },
    {
      icon: MapPin,
      label: 'Location',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const serviceId = import.meta.env.VITE_EMAILJS;
      const templateId = import.meta.env.VITE_TEMPLATE_ID;
      const publicKey = import.meta.env.VITE_PUBLIC_KEY;

      if (!serviceId || !templateId || !publicKey) {
        throw new Error(
          'Emailjs configuration is missing. Please check your .env '
        );
      }
