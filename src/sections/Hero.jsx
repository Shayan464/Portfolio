            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                  Hi, I'm Shayan Khan — a software engineer specializing in
                  React, Next.js,Mern stack and TypeScript. I build scalable,
              ...
              <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
                ...
                {[
                  { icon: Github, href: 'https://github.com/Shayan464' },
                  {
                    icon: Linkedin,
                    href: 'https://www.linkedin.com/in/shayan-khan-2ba67a331/',
                  },
                  {
                    icon: Instagram,
                    href: 'https://www.instagram.com/shayan__khan___',
                  },
                ].map((social, idx) => (
                  <a
                    key={idx}
